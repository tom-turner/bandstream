...
(function() {
				...
				sections = {
					'store': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#home' });
								},
							],
						},
					},
					'ourmission': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#ourmission' });
								},
							],
						},
					},
					'pricing': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#pricing' });
								},
							],
						},
					},
					'venuesdatabase': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#venuesdatabase' });
								},
							],
						},
					},
					'what-the-faq': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#what-the-faq' });
								},
							],
						},
					},
					'covid-19': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#covid-19' });
								},
							],
						},
					},
					'blm': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#blm' });
								},
							],
						},
					},
					'privacypolicy': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#privacypolicy' });
								},
							],
						},
					},
					'sorry': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-168435544-1', { 'page_path': '/#sorry' });
								},
							],
						},
					},
	...
	// Container: container07.
		new videoBackground('container07', {
			target: '#container07',
			src: 'assets/videos/container07.mp4',
			poster: 'assets/videos/container07.mp4.jpg',
			position: 'center',
			loop: true
		});
